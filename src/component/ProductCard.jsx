...
const ProductCard = ({
  ...
  for (let i = 1; i <= 5; i++) {
    stars.push(
      <svg className={` mt-auto size-6 stroke-blue-500 ${i<=currentRate?"  fill-yellow-300":""} stroke-blue-500 fill-yellow-300"`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  return (
    ...
    {stars}
      ...
      <div className="flex justify-between w-full mt-auto">
        <p className=' m-auto sm:ms-0'>{price * 3350} MMK</p>
