...
const Header = () => {
  return (
    <div className='p-4 fixed flex justify-between w-full text-center items-center bg-slate-100 shadow-md'>
      <h1 className="font-bold text-2xl lg:text-4xl md:text-3xl sm:text-2xl text-blue-500 uppercase">Ethan Ecommerce</h1>
      ...
      <div>
        <div class="text-center">
          ...
          <svg className="stroke-current hover:stroke-blue-500 hover:fill-white hover:shadow-slate-700 hover:shadow-sm-light hover:text-blue-500 w-8 h-8 text-xl rounded-md   text-blue-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24">
           ...
           <div className=' group'>
           <button className=' flex group-hover:text-blue-500 py-3 group-hover:rounded-md px-4'>
